...
import {
  LegacyCard, LegacyTabs,
  Text, InlineStack, Button, Toast, Frame, Modal, LegacyStack,
  TextContainer
...
export default function Settings() {
  ...
  const toggleModal = useCallback(() => { console.log('click'); setActiveModalViewDesktop((active) => !active) }, []);
      ...
      {loading ? (
        ...
        <div style={{ paddingRight: "20px" }}>
          ...
          <SaveBar id="my-save-bar">
            <button variant="primary" loading={loadingSaveSetting} onClick={handleSave}>
            </button>
          ...
          <div style={{
            ...
            <div style={{ width: "403px", height: "52px" }}>
              <p style={{ fontSize: "24px", fontWeight: "500", marginBottom: "5px" }}>
                Settings
              </p>
            ...
            size='large'
              primary
              onClick={handleSave}
              loading={loadingSaveSetting === "" ? true : false}
            >
              Save
            </Button> */}
          </div>
              ...
              <LegacyCard
                title={
                  <InlineStack align="space-between">
                    ...
                    <Button onClick={() => { toggleModal() }} size="slim">Desktop</Button>
                  </InlineStack>
                }
              >
                <div style={{
