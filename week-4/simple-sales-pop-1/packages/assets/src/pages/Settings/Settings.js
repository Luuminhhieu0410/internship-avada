...
export default function Settings() {
  ...
  const [settings, setSettings] = useState({
    ...
    firstDelay: 100, // thời gian đợi trước popup đầu tiên (seconds)
    popsInterval: 100, // khoảng thời gian giữa hai popup (seconds)
    maxPopupsDisplay: 100, // số popup tối đa cho phép hiển thị
    allShow: "all",
    excludeUrls: "",
    includeUrls: "",
  });
  ...
  const tabs = [
    {
      ...
      body: <DisplaySetting settings={settings} setSettings={setSettings} />,
      panelID: 'content-1',
    },
    {
      id: 1,
      content: <div style={{ color: selected == 1 ? "black" : "gray" }}>Triggers</div>,
      body: <TriggerSetting settings={settings} setSettings={setSettings} />,
      panelID: 'content-2',
    },
  ...
  return (
    <>
      {
        loading ? <PageSkeleton /> : <div style={{ paddingRight: "20px" }}>
